...
if(QTSINGLEAPPLICATION_INCLUDE_DIR AND QTSINGLEAPPLICATION_LIBRARY)
    ...
    find_library(QTSINGLEAPPLICATION_LIBRARY_DEBUG QtSolutions_SingleApplication-headd)
    find_library(QTSINGLEAPPLICATION_LIBRARY_RELEASE QtSolutions_SingleApplication-head)
    ...
    elseif(QTSINGLEAPPLICATION_LIBRARY_RELEASE)
        set(QTSINGLEAPPLICATION_LIBRARY ${QTSINGLEAPPLICATION_LIBRARY_RELEASE})
    endif()
